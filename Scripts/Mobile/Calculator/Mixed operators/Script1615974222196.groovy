...
Mobile.tap(findTestObject('Mobile/Calculator/Button - add'), GlobalVariable.DEFAULT_TIMEOUT)

Mobile.tap(findTestObject('Mobile/Calculator/Button - 1'), GlobalVariable.DEFAULT_TIMEOUT)

Mobile.tap(findTestObject('Mobile/Calculator/Button - divide'), GlobalVariable.DEFAULT_TIMEOUT)
...
Mobile.tap(findTestObject('Mobile/Calculator/Button - multiply'), GlobalVariable.DEFAULT_TIMEOUT)
