...
def response = WS.sendRequest(findTestObject('API/Bookstore/Books/GET Book by ISBN', [('ISBN') : '9781491904244']))
...
WS.verifyMatch(jsonBody.get("pages").toString(), "278" , false)
